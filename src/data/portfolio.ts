...
export const projectsIntro = {
  title: "Projects",
  description: "The following are some of my projects that I've worked on throughout the years."
};
...
export const ukgInternshipExperience = {
  ...
  description: [
    `I'm really excited to have the opportunity to participate in my first internship. Currently, I'm on the Pro Pay
      team at UKG, which essentially handles the payment applications related to tax purposes and other systems.
      The tech stack has been primarily C# with some F# as well. I'll make sure to update this section once I finish, with
      my experience, documentation, and reflection.`
  ]
};
...
export const mayaLexExperience = {
  ...
  repoUrls: ['https://github.com/kevinbarcenasmtz/MayaLEX', 'https://github.com/kevinbarcenasmtz/MAYALEX_Workflow'],
};
...
export const miscIntro = {
  title: "Miscellaneous",
  description: "Not entirely sure what to include in this section! It'll eventually be populated though with stuff I find fun or interesting.",
}